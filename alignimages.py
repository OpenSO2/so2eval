...
def alignimages(im1, im2):
	...
	# FIXME: use image depth to calc the actual scaling factor (this assumes 16bit)
	im1_8 = (im1/256).astype('uint8')
	im2_8 = (im2/256).astype('uint8')
	(cc, warp_matrix) = cv2.findTransformECC(im1_8, im2_8, warp_matrix, warp_mode, criteria)
